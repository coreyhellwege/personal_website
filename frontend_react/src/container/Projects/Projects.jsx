...
const Projects = () => {
    ...
    const handleProjectFilter = (item) => {
        ...
        setTimeout(() => {
            ...
            item === 'All' ? setFilterProject(projects) : setFilterProject(projects.filter(project => project.tags.includes(item)))
        }, 500);
    }
    ...
    return <>
        ...
        <div className='app__project-filter'>
            {['React JS', 'Node JS', 'Mongo DB', 'Express JS', 'Next JS', 'Sanity', 'All'].map((item, index) => (
                <div 
                    key={index} 
